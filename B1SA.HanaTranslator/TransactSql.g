...
@lexer::namespace {B1SA.HanaTranslator}
@parser::namespace {B1SA.HanaTranslator}
...
@members
{
    ...
    {
        Console.WriteLine(String.Format(Resources.MSG_STATEMENT_NOT_SUPPORTED, 
...
constant returns [ConstantExpression res]
    ...
    |   Integer { $res = new IntegerConstantExpression(Int32.Parse($Integer.Text)); }
    |   Decimal { $res = new DecimalConstantExpression(System.Decimal.Parse($Decimal.Text, System.Globalization.CultureInfo.InvariantCulture)); }
...
decimalLiteral returns [Decimal res]
    :   Integer { $res = System.Decimal.Parse($Integer.Text, System.Globalization.CultureInfo.InvariantCulture); }
    |   Decimal { $res = System.Decimal.Parse($Decimal.Text, System.Globalization.CultureInfo.InvariantCulture); }
    ;
