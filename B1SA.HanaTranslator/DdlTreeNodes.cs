namespace B1SA.HanaTranslator
{
    ...
    public class CreateTableStatement : Statement
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            if (IsFileTable) {
                AddNote(Note.STRINGIFIER, Resources.NO_AS_FILETABLE);
            }
            ...
            if (Definitions != null) {
                ...
                if (Definitions.Count != 0) {
                    ...
                    AddNote(Note.STRINGIFIER, Resources.WARN_NO_COLUMNS_IN_CREATE);
                }
                asm.AddToken(")");
            }
            if (OnClause != null) {
                AddNote(Note.STRINGIFIER, String.Format(Resources.CLAUSE_NOT_IN_CREATE_TABLE, "ON"));
            }
            if (TextImageOnClause != null) {
                AddNote(Note.STRINGIFIER, String.Format(Resources.CLAUSE_NOT_IN_CREATE_TABLE, "TEXTIMAGE_ON"));
            }
            if (FileStreamOnClause != null) {
                AddNote(Note.STRINGIFIER, String.Format(Resources.CLAUSE_NOT_IN_CREATE_TABLE, "FILESTREAM_ON"));
            }
            if (TableOptions != null) {
                AddNote(Note.STRINGIFIER, String.Format(Resources.CLAUSE_NOT_IN_CREATE_TABLE, "WITH"));
            }
            asm.DecreaseIndentation();
            asm.End(this);
        }
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            switch (Type) {
                case SimpleColumnDefinitionModifierType.FileStream:
                    AddNote(Note.STRINGIFIER, Resources.NO_FILESTREAM_CLAUSE);
                    break;
                ...
                case SimpleColumnDefinitionModifierType.RowGuidCol:
                    AddNote(Note.STRINGIFIER, Resources.NO_ROWGUIDCOL_CLAUSE);
                    break;
                case SimpleColumnDefinitionModifierType.Sparse:
                    AddNote(Note.STRINGIFIER, Resources.NO_SPARSE_CLAUSE);
                    break;
            }
            asm.End(this);
        }
    ...
    public class CollationColumnDefinitionModifier : ColumnDefinitionModifier
    {
        ...
        {
            asm.Begin(this);
            AddNote(Note.STRINGIFIER, Resources.NO_COLLATE_CLAUSE);
            asm.End(this);
        }
    }
    #endregion
    ...
    public class IdentityColumnDefinitionModifier : ColumnDefinitionModifier
    {
        ...
        {
            asm.Begin(this);
            AddNote(Note.STRINGIFIER, Resources.NO_IDENTITY_CLAUSE);
            asm.End(this);
        }
    }
    #endregion
    ...
    public class ComputedColumnDefinition : CreateTableDefinition
    {
        ...
        {
            asm.Begin(this);
            AddNote(Note.STRINGIFIER, Resources.NO_COMPUTED_COLUMN);
            asm.End(this);
        }
    }
    ...
    public class PrimaryKeyColumnConstraint : ColumnConstraint
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            if (IndexOptions != null) {
                AddNote(Note.STRINGIFIER, String.Format(Resources.NO_PRIMARY_KEY_COLUMN_CONSTRAINT, "Index option"));
            }
            if (OnClause != null) {
                AddNote(Note.STRINGIFIER, String.Format(Resources.NO_PRIMARY_KEY_COLUMN_CONSTRAINT, "ON clause"));
            }
            asm.End(this);
        }
    }
    ...
    public class ForeignKeyColumnConstraint : ColumnConstraint
    {
        ...
        {
            asm.Begin(this);
            AddNote(Note.STRINGIFIER, String.Format(Resources.NO_COLUMN_CONSTRAINT, "FOREIGN KEY"));
            asm.End(this);
        }
    }
    ...
    public class CheckColumnConstraint : ColumnConstraint
    {
        ...
        {
            asm.Begin(this);
            AddNote(Note.STRINGIFIER, String.Format(Resources.NO_COLUMN_CONSTRAINT, "CHECK"));
            asm.End(this);
        }
    }
    ...
    public class PrimaryKeyTableConstraint : TableConstraint
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            if (Columns.Count != 0) {
                ...
                AddNote(Note.STRINGIFIER, Resources.NO_COLUMNS_DEFINED_FOR_PK);
                asm.End(this);
                return;
            }
    ...
    public class ForeignKeyTableConstraint : TableConstraint
    {
        ...
        {
            asm.Begin(this);
            AddNote(Note.STRINGIFIER, String.Format(Resources.NO_TABLE_CONSTRAINT, "FOREIGN KEY"));
            asm.End(this);
        }
    }
    ...
    public class CheckTableConstraint : TableConstraint
    {
        ...
        {
            asm.Begin(this);
            AddNote(Note.STRINGIFIER, String.Format(Resources.NO_TABLE_CONSTRAINT, "CHECK"));
            asm.End(this);
        }
    }
    ...
    public class DefaultTableConstraint : TableConstraint
    {
        ...
        {
            asm.Begin(this);
            AddNote(Note.STRINGIFIER, String.Format(Resources.NO_TABLE_CONSTRAINT, "DEFAULT"));
            asm.End(this);
        }
    }
    #endregion
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            switch (Type) {
                case PrimaryKeyOrUnique.PrimaryKey:
                    if (Clustered == false) {
                        AddNote(Note.STRINGIFIER, String.Format(Resources.NO_PRIMARY_KEY_COLUMN_CONSTRAINT, "NONCLUSTERED clause"));
                    }
                    asm.AddToken("PRIMARY KEY");
                    break;
                case PrimaryKeyOrUnique.Unique:
                    if (Clustered == true) {
                        AddNote(Note.STRINGIFIER, Resources.NO_CLUSTERED_FOR_UNIQUE_COLUMN);
                    }
                    asm.AddToken("UNIQUE");
                    break;
            }
    ...
    public class AlterTableStatement : Statement
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            if (Action != null) {
                ...
                AddNote(Note.STRINGIFIER, Resources.WARN_NO_ACTION_IN_ALTER_TABLE);
            }
            asm.End(this);
        }
    }
    ...
    public class CreateIndexStatement : Statement
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            asm.Add(IndexTarget);
            if (Name == null) {
                AddNote(Note.STRINGIFIER, Resources.WARN_NO_INDEX_NAME_IN_CREATE);
                asm.End(this);
                return;
            }
            if (IndexTarget == null) {
                AddNote(Note.STRINGIFIER, Resources.WARN_NO_TABLE_NAME_IN_CREATE_INDEX);
                asm.End(this);
                return;
            }
            ...
            if (IndexColumns != null && IndexColumns.Count > 0) {
                ...
                AddNote(Note.STRINGIFIER, Resources.WARN_NO_COLUMNS_IN_CREATE_INDEX);
            }

            if (Clustered != null) {
                if (Clustered.Value == true) {
                    AddNote(Note.STRINGIFIER, Resources.NO_CLUSTERED_INDEX);
                }
                else {
                    AddNote(Note.STRINGIFIER, Resources.WARN_NO_NONCLUSTERED);
                }
            }
            if (IncludeColumns != null && IncludeColumns.Count > 0) {
                AddNote(Note.STRINGIFIER, Resources.NO_INCLUDE_CLAUSE);
            }
            if (Condition != null) {
                AddNote(Note.STRINGIFIER, Resources.NO_WHERE_CLAUSE_FOR_CREATE_INDEX);
            }
            if (Options != null) {
                AddNote(Note.STRINGIFIER, Resources.NO_WITH_ON_HANA);
            }
            if (OnClause != null) {
                AddNote(Note.STRINGIFIER, Resources.NO_ON_CLAUSE_FOR_CREATE_INDEX);
            }
            if (FileStreamOnClause != null) {
                AddNote(Note.STRINGIFIER, Resources.NO_FILETSTREAM_ON_FOR_CREATE_INDEX);
            }
            asm.End(this);
        }
    }
    ...
    public class DropIndexAction : GrammarNode
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            asm.Add(Index);
            if (Options != null) {
                AddNote(Note.STRINGIFIER, Resources.NO_OPTIONS_FOR_DROP_INDEX);
            }
            asm.End(this);
        }
    }
    ...
    public class DataTypeProcedureParameter : ProcedureParameter
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            if (DefaultValue != null) {
                AddNote(Note.STRINGIFIER, Resources.NO_DEFAULT_VALUES_PROCEDURE_INPUT_PARAMETERS);
            }
            asm.End(this);
        }
    }
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            switch (ApplType) {
                case TriggerApplType.AFTER:
                    ...
                    break;
                default:
                    AddNote(Note.STRINGIFIER, String.Format(Resources.TYPE_NOT_SUPPORTED, ApplType.ToString()));
                    break;
            }
            asm.AddSpace();
