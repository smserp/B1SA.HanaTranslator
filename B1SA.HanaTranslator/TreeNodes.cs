namespace B1SA.HanaTranslator
{
    ...
    public class ExecStatementSQL : ExecStatement
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            asm.Add("(");
            if (Params != null)
                Expression.AddNote(Note.STRINGIFIER, Resources.NO_PARAMS_IN_EXEC);
    ...
    public class ExecStatementSP : ExecStatement
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            if (ReturnVariable != null) {
                ReturnVariable.AddNote(Note.STRINGIFIER, Resources.NO_RET_VAR_IN_EXEC);
            }
            asm.End(this);
        }
    }
    ...
    public class DbObjectExecModuleName : ExecModuleName
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            if (Number >= 0) {
                AddNote(Note.STRINGIFIER, Resources.NO_MODULE_NUMBER_IN_EXEC);
            }
            asm.Add(Name);
            asm.End(this);
        }
    ...
    public class InsertStatement : WithSupportingStatement
    {
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            if (ValuesClause is ValuesClauseExec) {
                ...
                InsertTarget.AddNote(Note.STRINGIFIER, Resources.NO_INSERT_TARGET_IN_INSERT);
            }
    ...
    public class WhereClauseCursor : WhereClauseSupportingCursor
    {
        ...
        override public void Assembly(Assembler asm)
        {
            ...
            AddNote(Note.STRINGIFIER, Resources.NO_CURSOR_IN_WHERE_CLAUSE);
        }
    }
