...
namespace B1SA.HanaTranslator
{
        ...
        public override void Assembly(Assembler asm)
        {
            ...
            switch (Operator) {
                case BinaryBitwiseOperatorType.Or:
                    AddNote(Note.STRINGIFIER, Resources.NO_BITWISE_OR_OPERATOR);
                    asm.End(this);
                    return;
                case BinaryBitwiseOperatorType.Xor:
                    AddNote(Note.STRINGIFIER, Resources.NO_BITWISE_XOR_OPERATOR);
                    asm.End(this);
                    return;
            }
    ...
    public class DecimalConstantExpression : ConstantExpression
    {
        ...
        {
            asm.Begin(this);
            asm.Add(Value.ToString(CultureInfo.InvariantCulture));
            asm.End(this);
        }
    }
