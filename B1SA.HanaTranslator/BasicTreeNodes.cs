        ...
        override public void Assembly(Assembler asm)
        {
            ...
            switch (Type) {
                ...
                case SimpleBuiltinDataTypeType.HierarchyId:
                    AddNote(Note.STRINGIFIER, Resources.NO_TYPE_HIERARCHYID);
                    break;
                case SimpleBuiltinDataTypeType.RowVersion:
                    asm.AddToken("rowversion");
                    break;    // TODO check
                case SimpleBuiltinDataTypeType.SqlVariant:
                    AddNote(Note.STRINGIFIER, Resources.NO_TYPE_SQL_VARIANT);
                    break;
                ...
                case SimpleBuiltinDataTypeType.UniqueIdentifier:
                    ...
                    break;
                default:
                    throw new Exception(Resources.MSG_INTERNAL_ERROR);
            }
            asm.End(this);
        }
    }
        ...
        override public void Assembly(Assembler asm)
        {
            ...
            switch (Type) {
                ...
                case DateTimePrecisionDataTypeType.DateTimeOffset:
                    AddNote(Note.STRINGIFIER, Resources.NO_DATETIMEOFFSET);
                    return;
            ...
            if (Precision != PrecisionDefault) {
                AddNote(Note.MODIFIER, Resources.MSG_REMOVED_LENGTHS_FOR_DATETIME2);
            }
            asm.End(this);
        }
    }
    ...
    public class GenericDataType : DataType
    {
        ...
        override public void Assembly(Assembler asm)
        {
            ...
            switch (Name.Name.ToLowerInvariant()) {
                case "xml":
                    AddNote(Note.STRINGIFIER, Resources.NO_TYPE_XML);
                    break;
                default:
                    if (Schema != null) {
                        asm.Add(Schema);
